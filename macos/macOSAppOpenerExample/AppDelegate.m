...
-(id)init
{
    if(self = [super init]) {
        ...
        [windowController setWindowFrameAutosaveName:@"macOSAppOpenerExample"];
...
- (void)applicationDidFinishLaunching:(__unused NSNotification *)aNotification
{
    ...
    RCTRootView *rootView = [[RCTRootView alloc] initWithBridge:_bridge
                                                     moduleName:@"macOSAppOpenerExample"
...
- (void)setUpApplicationMenu
{
    ...
    [rootMenu addItemWithTitle:@"Quit macOSAppOpenerExample" action:@selector(terminate:) keyEquivalent:@"q"];
